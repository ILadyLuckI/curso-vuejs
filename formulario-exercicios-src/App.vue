	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<!--Testando modificadores de input-->
				<Rotulo nome="E-mail">
					<!--lazy atualiza os dados apenas quando o usuario sair do campo 'input'-->
					<!--trim remove espaços em branco antes e depois do que for digitado no campo-->
				...
				<hr>
				<!--a propriedade 'prevent', previne o navegador de enviar o formulario,
				então o formulário não será enviado de verdade, e ele vai chamar uma função
				chamada 'enviar', que será definida dentro dos 'methods'-->
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Mensagem">
					<!--a propriedade 'pre', preserva os espaços em branco no campo 'Mensagem'
					permitindo a quebra de linha-->
...
.painel {
	...
	margin: 0px 10px;
	padding: 20px;
	border: 1px solid #2a46fc;
	border-radius: 5px;
}

.painel .cabecalho {
	width: 100%;
	background-color: #0313c1;
	padding: 10px 0px;
	border-radius: 5px;
	font-size: 1.4rem;
	color: white;
